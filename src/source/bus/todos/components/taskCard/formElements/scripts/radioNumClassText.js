...
const b = ['', '', 'twentieth', 'thirtieth', 'fortieth', 'fiftieth', 'sixtieth', 'seventieth', 'eightieth', 'ninetieth'];
...
export function numWords (input) {
  ...
  str += n1 != 0 ? (getLT20(n1) || getGT20(n1)) + 'croreth ' : ''; 
  // eslint-disable-next-line
  str += n2 != 0 ? (getLT20(n2) || getGT20(n2)) + 'lakhth ' : ''; 
  // eslint-disable-next-line
  str += n3 != 0 ? (getLT20(n3) || getGT20(n3)) + 'thousandth ' : ''; 
  // eslint-disable-next-line
  str += n4 != 0 ? getLT20(n4) + 'hundredth ' : '';
  // eslint-disable-next-line
  str += n5 != 0 && str != '' ? 'and ' : ''; 
  // eslint-disable-next-line
